...
void NRooTrackerVtx::Init() {
  ///< Also some additional fields which will be useful
  ///< JIMTODO - I need to stop instantialtion of these objects in the default
  ///< constructor as this causes a memory leak when using i/o of cint
...
void NRooTrackerVtx::Print(const Option_t* option) const {
